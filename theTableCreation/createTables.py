...
def issuetable():
    global mycursor
    mycursor.execute(
        "create table IssueTable(issueId int auto_increment, bookId varchar(30), userId varchar(20), DateIssued date, primary key(issueId))")
...
def returnTable():
    global mycursor
    mycursor.execute(
        "create table ReturnTable(returnId int auto_increment, bookId varchar(30), userId varchar(20), DateReturned date, primary key(returnId))")
